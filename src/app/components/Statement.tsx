...
export default function Statement() {
  return (
    <section id="statement" className="relative bg-espresso py-20 sm:py-36 px-6 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_10%_80%,rgba(195,128,90,0.12),transparent_55%)]" />

      <div className="relative max-w-6xl mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-20 items-center">
        <motion.div
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl text-porcelain mt-4 mb-6 sm:mb-8">In His Own Words</h2>
          <p className="text-cream-dim/90 leading-loose text-base sm:text-[1.05rem]">
